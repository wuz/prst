...
}:
{
  ...
  "are-na" = buildFirefoxXpiAddon {
    ...
    url = "https://addons.mozilla.org/firefox/downloads/file/4467283/are_na-2.10.2.xpi";
    sha256 = "3eb4f0f3102c8cd0d0211c0c024af7f8484e19a0d7b911121df21aadd2b71225";
    meta = with lib; {
  ...
  "rss-reader-extension-inoreader" = buildFirefoxXpiAddon {
    ...
    url = "https://addons.mozilla.org/firefox/downloads/file/4486788/rss_reader_extension_inoreader-6.0.5.xpi";
    sha256 = "5de44764fa5d1a4710933d203901b1df7e03e84fe316eb37c44d0b33bca2ff74";
    meta = with lib; {
  ...
  "zen-internet" = buildFirefoxXpiAddon {
    ...
    url = "https://addons.mozilla.org/firefox/downloads/file/4492039/zen_internet-2.2.3.xpi";
    sha256 = "3502809871f1702e696e580b95415d61eac4de1ceae09005f80f75dad50a08c9";
    meta = with lib; {
